...
import { CreatePermissionRequestDto } from '../users/dto/permissionRequest/create-permission-request.dto';
import { PaginationPermissionRequestDto } from '../users/dto/permissionRequest/pagination-permission-request.dto';
import { PermissionRequestDto } from '../users/dto/permissionRequest/permission-request.dto';
import { ChangeLocalUserProfileDetailDto } from '../users/dto/user/change-local-user-profile-detail.dto';
import { UserPermissionRequest } from '../users/entities/permission-requests.entity';
import { PermissionRequestsService } from '../users/permissionRequests.service';
...
export class AuthController {
  ...
  @ApiBody({ required: true, type: LoginCredentialsDto })
  @Post('login')
  ...
  @Get('all')
  @UseGuards(AccessTokenGuard, RolesGuard)
  @Roles(UserRoles.superUser, UserRoles.admin, UserRoles.doctorsAdmin)
  @Serialize(UserDto)
